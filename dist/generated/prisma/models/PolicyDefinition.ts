...
// @ts-nocheck 
/*
 * This file exports the `PolicyDefinition` model and its related types.
 *
...
export type GetPolicyDefinitionAggregateType<T extends PolicyDefinitionAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePolicyDefinition[P]>
    : Prisma.GetScalarType<T[P], AggregatePolicyDefinition[P]>
}
...
type GetPolicyDefinitionGroupByPayload<T extends PolicyDefinitionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PolicyDefinitionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PolicyDefinitionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PolicyDefinitionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PolicyDefinitionGroupByOutputType[P]>
      }
    >
  >
...
export type PolicyDefinitionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PolicyDefinitionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PolicyDefinitionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends PolicyDefinitionCountArgs>(
    args?: Prisma.Subset<T, PolicyDefinitionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PolicyDefinitionCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, PolicyDefinitionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPolicyDefinitionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
