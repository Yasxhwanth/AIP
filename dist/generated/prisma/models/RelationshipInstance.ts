...
// @ts-nocheck 
/*
 * This file exports the `RelationshipInstance` model and its related types.
 *
...
export type GetRelationshipInstanceAggregateType<T extends RelationshipInstanceAggregateArgs> = {
      [P in keyof T & keyof AggregateRelationshipInstance]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRelationshipInstance[P]>
    : Prisma.GetScalarType<T[P], AggregateRelationshipInstance[P]>
}
...
type GetRelationshipInstanceGroupByPayload<T extends RelationshipInstanceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RelationshipInstanceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RelationshipInstanceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RelationshipInstanceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RelationshipInstanceGroupByOutputType[P]>
      }
    >
  >
...
export type RelationshipInstanceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<RelationshipInstanceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RelationshipInstanceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['RelationshipInstance'], meta: { name: 'RelationshipInstance' } }
  /**
   ...
   * })
  **/
  count<T extends RelationshipInstanceCountArgs>(
    args?: Prisma.Subset<T, RelationshipInstanceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RelationshipInstanceCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends RelationshipInstanceGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, RelationshipInstanceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRelationshipInstanceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
