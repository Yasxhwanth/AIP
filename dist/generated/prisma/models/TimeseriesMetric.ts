...
// @ts-nocheck 
/*
 * This file exports the `TimeseriesMetric` model and its related types.
 *
...
export type GetTimeseriesMetricAggregateType<T extends TimeseriesMetricAggregateArgs> = {
      [P in keyof T & keyof AggregateTimeseriesMetric]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTimeseriesMetric[P]>
    : Prisma.GetScalarType<T[P], AggregateTimeseriesMetric[P]>
}
...
type GetTimeseriesMetricGroupByPayload<T extends TimeseriesMetricGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TimeseriesMetricGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TimeseriesMetricGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TimeseriesMetricGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TimeseriesMetricGroupByOutputType[P]>
      }
    >
  >
...
export type TimeseriesMetricCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TimeseriesMetricFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TimeseriesMetricDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TimeseriesMetric'], meta: { name: 'TimeseriesMetric' } }
  /**
   ...
   * })
  **/
  count<T extends TimeseriesMetricCountArgs>(
    args?: Prisma.Subset<T, TimeseriesMetricCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TimeseriesMetricCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TimeseriesMetricGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TimeseriesMetricGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTimeseriesMetricGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
