...
// @ts-nocheck 
/*
 * This file exports the `InferenceResult` model and its related types.
 *
...
export type GetInferenceResultAggregateType<T extends InferenceResultAggregateArgs> = {
      [P in keyof T & keyof AggregateInferenceResult]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInferenceResult[P]>
    : Prisma.GetScalarType<T[P], AggregateInferenceResult[P]>
}
...
type GetInferenceResultGroupByPayload<T extends InferenceResultGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InferenceResultGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InferenceResultGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InferenceResultGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InferenceResultGroupByOutputType[P]>
      }
    >
  >
...
export type InferenceResultCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<InferenceResultFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InferenceResultDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['InferenceResult'], meta: { name: 'InferenceResult' } }
  /**
   ...
   * })
  **/
  count<T extends InferenceResultCountArgs>(
    args?: Prisma.Subset<T, InferenceResultCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InferenceResultCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends InferenceResultGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, InferenceResultGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInferenceResultGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
