...
// @ts-nocheck 
/*
 * This file exports the `RelationshipDefinition` model and its related types.
 *
...
export type GetRelationshipDefinitionAggregateType<T extends RelationshipDefinitionAggregateArgs> = {
      [P in keyof T & keyof AggregateRelationshipDefinition]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRelationshipDefinition[P]>
    : Prisma.GetScalarType<T[P], AggregateRelationshipDefinition[P]>
}
...
type GetRelationshipDefinitionGroupByPayload<T extends RelationshipDefinitionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RelationshipDefinitionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RelationshipDefinitionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RelationshipDefinitionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RelationshipDefinitionGroupByOutputType[P]>
      }
    >
  >
...
export type RelationshipDefinitionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<RelationshipDefinitionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RelationshipDefinitionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['RelationshipDefinition'], meta: { name: 'RelationshipDefinition' } }
  /**
   ...
   * })
  **/
  count<T extends RelationshipDefinitionCountArgs>(
    args?: Prisma.Subset<T, RelationshipDefinitionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RelationshipDefinitionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends RelationshipDefinitionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, RelationshipDefinitionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRelationshipDefinitionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
