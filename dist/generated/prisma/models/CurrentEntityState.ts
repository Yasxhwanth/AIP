...
// @ts-nocheck 
/*
 * This file exports the `CurrentEntityState` model and its related types.
 *
...
export type GetCurrentEntityStateAggregateType<T extends CurrentEntityStateAggregateArgs> = {
      [P in keyof T & keyof AggregateCurrentEntityState]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCurrentEntityState[P]>
    : Prisma.GetScalarType<T[P], AggregateCurrentEntityState[P]>
}
...
type GetCurrentEntityStateGroupByPayload<T extends CurrentEntityStateGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CurrentEntityStateGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CurrentEntityStateGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CurrentEntityStateGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CurrentEntityStateGroupByOutputType[P]>
      }
    >
  >
...
export type CurrentEntityStateCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CurrentEntityStateFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CurrentEntityStateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CurrentEntityState'], meta: { name: 'CurrentEntityState' } }
  /**
   ...
   * })
  **/
  count<T extends CurrentEntityStateCountArgs>(
    args?: Prisma.Subset<T, CurrentEntityStateCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CurrentEntityStateCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CurrentEntityStateGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CurrentEntityStateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCurrentEntityStateGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
