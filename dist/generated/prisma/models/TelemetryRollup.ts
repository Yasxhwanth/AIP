...
// @ts-nocheck 
/*
 * This file exports the `TelemetryRollup` model and its related types.
 *
...
export type GetTelemetryRollupAggregateType<T extends TelemetryRollupAggregateArgs> = {
      [P in keyof T & keyof AggregateTelemetryRollup]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTelemetryRollup[P]>
    : Prisma.GetScalarType<T[P], AggregateTelemetryRollup[P]>
}
...
type GetTelemetryRollupGroupByPayload<T extends TelemetryRollupGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TelemetryRollupGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TelemetryRollupGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TelemetryRollupGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TelemetryRollupGroupByOutputType[P]>
      }
    >
  >
...
export type TelemetryRollupCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TelemetryRollupFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TelemetryRollupDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TelemetryRollup'], meta: { name: 'TelemetryRollup' } }
  /**
   ...
   * })
  **/
  count<T extends TelemetryRollupCountArgs>(
    args?: Prisma.Subset<T, TelemetryRollupCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TelemetryRollupCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TelemetryRollupGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TelemetryRollupGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTelemetryRollupGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
