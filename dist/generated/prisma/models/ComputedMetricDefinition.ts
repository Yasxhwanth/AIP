...
// @ts-nocheck 
/*
 * This file exports the `ComputedMetricDefinition` model and its related types.
 *
...
export type GetComputedMetricDefinitionAggregateType<T extends ComputedMetricDefinitionAggregateArgs> = {
      [P in keyof T & keyof AggregateComputedMetricDefinition]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateComputedMetricDefinition[P]>
    : Prisma.GetScalarType<T[P], AggregateComputedMetricDefinition[P]>
}
...
type GetComputedMetricDefinitionGroupByPayload<T extends ComputedMetricDefinitionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ComputedMetricDefinitionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ComputedMetricDefinitionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ComputedMetricDefinitionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ComputedMetricDefinitionGroupByOutputType[P]>
      }
    >
  >
...
export type ComputedMetricDefinitionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ComputedMetricDefinitionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ComputedMetricDefinitionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ComputedMetricDefinition'], meta: { name: 'ComputedMetricDefinition' } }
  /**
   ...
   * })
  **/
  count<T extends ComputedMetricDefinitionCountArgs>(
    args?: Prisma.Subset<T, ComputedMetricDefinitionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ComputedMetricDefinitionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ComputedMetricDefinitionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ComputedMetricDefinitionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetComputedMetricDefinitionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
