...
// @ts-nocheck 
/*
 * This file exports the `EntityInstance` model and its related types.
 *
...
export type GetEntityInstanceAggregateType<T extends EntityInstanceAggregateArgs> = {
      [P in keyof T & keyof AggregateEntityInstance]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateEntityInstance[P]>
    : Prisma.GetScalarType<T[P], AggregateEntityInstance[P]>
}
...
type GetEntityInstanceGroupByPayload<T extends EntityInstanceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<EntityInstanceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof EntityInstanceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], EntityInstanceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], EntityInstanceGroupByOutputType[P]>
      }
    >
  >
...
export type EntityInstanceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<EntityInstanceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EntityInstanceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['EntityInstance'], meta: { name: 'EntityInstance' } }
  /**
   ...
   * })
  **/
  count<T extends EntityInstanceCountArgs>(
    args?: Prisma.Subset<T, EntityInstanceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], EntityInstanceCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends EntityInstanceGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, EntityInstanceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEntityInstanceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
