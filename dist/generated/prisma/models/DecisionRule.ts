...
// @ts-nocheck 
/*
 * This file exports the `DecisionRule` model and its related types.
 *
...
export type GetDecisionRuleAggregateType<T extends DecisionRuleAggregateArgs> = {
      [P in keyof T & keyof AggregateDecisionRule]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDecisionRule[P]>
    : Prisma.GetScalarType<T[P], AggregateDecisionRule[P]>
}
...
type GetDecisionRuleGroupByPayload<T extends DecisionRuleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DecisionRuleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DecisionRuleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DecisionRuleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DecisionRuleGroupByOutputType[P]>
      }
    >
  >
...
export type DecisionRuleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DecisionRuleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DecisionRuleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DecisionRule'], meta: { name: 'DecisionRule' } }
  /**
   ...
   * })
  **/
  count<T extends DecisionRuleCountArgs>(
    args?: Prisma.Subset<T, DecisionRuleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DecisionRuleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DecisionRuleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DecisionRuleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDecisionRuleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
