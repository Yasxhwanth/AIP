...
// @ts-nocheck 
/*
 * This file exports the `ProvenanceRecord` model and its related types.
 *
...
export type GetProvenanceRecordAggregateType<T extends ProvenanceRecordAggregateArgs> = {
      [P in keyof T & keyof AggregateProvenanceRecord]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProvenanceRecord[P]>
    : Prisma.GetScalarType<T[P], AggregateProvenanceRecord[P]>
}
...
type GetProvenanceRecordGroupByPayload<T extends ProvenanceRecordGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ProvenanceRecordGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ProvenanceRecordGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ProvenanceRecordGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ProvenanceRecordGroupByOutputType[P]>
      }
    >
  >
...
export type ProvenanceRecordCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ProvenanceRecordFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ProvenanceRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ProvenanceRecord'], meta: { name: 'ProvenanceRecord' } }
  /**
   ...
   * })
  **/
  count<T extends ProvenanceRecordCountArgs>(
    args?: Prisma.Subset<T, ProvenanceRecordCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ProvenanceRecordCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ProvenanceRecordGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ProvenanceRecordGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProvenanceRecordGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
