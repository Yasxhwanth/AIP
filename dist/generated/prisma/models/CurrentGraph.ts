...
// @ts-nocheck 
/*
 * This file exports the `CurrentGraph` model and its related types.
 *
...
export type GetCurrentGraphAggregateType<T extends CurrentGraphAggregateArgs> = {
      [P in keyof T & keyof AggregateCurrentGraph]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCurrentGraph[P]>
    : Prisma.GetScalarType<T[P], AggregateCurrentGraph[P]>
}
...
type GetCurrentGraphGroupByPayload<T extends CurrentGraphGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CurrentGraphGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CurrentGraphGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CurrentGraphGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CurrentGraphGroupByOutputType[P]>
      }
    >
  >
...
export type CurrentGraphCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CurrentGraphFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CurrentGraphDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CurrentGraph'], meta: { name: 'CurrentGraph' } }
  /**
   ...
   * })
  **/
  count<T extends CurrentGraphCountArgs>(
    args?: Prisma.Subset<T, CurrentGraphCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CurrentGraphCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CurrentGraphGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CurrentGraphGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCurrentGraphGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
