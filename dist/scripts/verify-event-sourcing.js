...
verify()
    ...
    fs.writeFileSync('verification_error.json', JSON.stringify(err, (key, value) => typeof value === 'bigint' ? value.toString() : value, 2));
    process.exit(1);
})
    .finally(async () => {
    await prisma.$disconnect();
});
//# sourceMappingURL=verify-event-sourcing.js.map