...
async function main() {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${baseUrl}/api/v1/ontology/entity-types/Drone/instances/bulk`, payload, {
            headers: {
        ...
        while (attempts < maxAttempts) {
            const outboxStats = await axios_1.default.get(`${baseUrl}/api/v1/telemetry/outbox`, {
                headers: { 'X-Project-Id': projectId }
            });
            const recent = outboxStats.data.recent;
            const targetEvent = recent.find((ev) => ev.payload.logicalId === payload.items[0].logicalId);
            if (targetEvent) {
...
//# sourceMappingURL=verify-outbox.js.map