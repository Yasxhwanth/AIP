...
async function main() {
    ...
    try {
        ...
        if (!project)
            throw new Error('Project not found. Run seed first.');
        ...
        const entity = await prisma.currentEntityState.findFirst({ where: { projectId } });
        if (!entity)
            throw new Error('No entities found for project.');
...
//# sourceMappingURL=test-aip-tools.js.map